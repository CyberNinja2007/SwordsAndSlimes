        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Пожалуйста подтвердите ваш новый email по этой <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>ссылке</a>.");

                StatusMessage = "Ссылка для подтверждения изменений отправлена на ваш email.";
